...
public class FinalTopHundred {
    static TreeMap <String, Integer> PairsFreqsMap = new TreeMap();
    static TreeMap <String, Integer> SingleFreqMap = new TreeMap();
    static TreeMap <String, Integer> RelPairFeqMap = new TreeMap();
    static TreeMap <String, Integer> TopHundredMap = new TreeMap();
    ...
    //Cleanup
  	...
  	// calculating top hundred in a tree map
      	  ...
      	  //**** Writing to TopHundredMap
      	            RelPairFreqMap.put(pairsKey, relativeFreq);
      	 
  	            } // For Loop ends
        
                TopHundredMap=sortByValues(RelPairFreqMap);
